...
/* Generated into provenance.c by scripts/build-wasm.sh from ledger.json. */
extern const char treebank_provenance[];
...
const char *EXPORT(tb_provenance)(void) { return treebank_provenance; }
