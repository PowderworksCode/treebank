...
; expanded into yaml's own node types. Edit queries/locals.scm and
; regenerate, or the next --check will fail.
;
; Omitted: yaml has no _callable, _parameter.
...
[(anchor name: (_) @local.definition.var)]
...
[(anchor_name) (directive_name)] @local.reference
