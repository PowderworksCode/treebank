...
- NAME rejects [AND, AS, ASC, BY, CREATE, DELETE, DESC, DROP, FROM, ILIKE, INSERT, INT, INTO, LIKE, LIMIT, NOT, NULL, OFFSET, OIDS, OR, ORDER, OVER, PARTITION, RETURNING, SELECT, SET, TABLE, TEXT, UPDATE, VALUES, VARCHAR, WHERE, WITH, WITHOUT]: the matched text is compared against the list, which is SDF3's reject production exactly
