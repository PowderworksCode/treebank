...
module.exports = grammar({
  ...
  reserved: { global: $ => ["AND", "AS", "ASC", "BY", "CONFLICT", "CREATE", "DELETE", "DESC", "DO", "DROP", "FROM", "ILIKE", "INSERT", "INT", "INTO", "LIKE", "LIMIT", "NOT", "NOTHING", "NULL", "OFFSET", "OIDS", "ON", "OR", "ORDER", "OVER", "PARTITION", "RETURNING", "SELECT", "SET", "TABLE", "TEXT", "UPDATE", "VALUES", "VARCHAR", "WHERE", "WITH", "WITHOUT"] },
  rules: {
