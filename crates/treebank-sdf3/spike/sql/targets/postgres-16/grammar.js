...
module.exports = grammar({
  ...
  reserved: { global: $ => ["AND", "AS", "ASC", "BY", "CONFLICT", "CREATE", "DELETE", "DESC", "DO", "DROP", "FROM", "ILIKE", "INSERT", "INT", "INTO", "LIKE", "LIMIT", "MATCHED", "MERGE", "NOT", "NOTHING", "NULL", "OFFSET", "OIDS", "ON", "OR", "ORDER", "OVER", "PARTITION", "RETURNING", "SELECT", "SET", "TABLE", "TEXT", "THEN", "UPDATE", "USING", "VALUES", "VARCHAR", "WHEN", "WHERE", "WITH", "WITHOUT"] },
  rules: {
