...
module.exports = grammar({
  ...
  reserved: { global: $ => [$._kw_and, $._kw_as, $._kw_asc, $._kw_by, $._kw_create, $._kw_delete, $._kw_desc, $._kw_drop, $._kw_duplicate, $._kw_from, $._kw_ignore, $._kw_insert, $._kw_int, $._kw_into, $._kw_key, $._kw_like, $._kw_limit, $._kw_not, $._kw_null, $._kw_offset, $._kw_on, $._kw_or, $._kw_order, $._kw_over, $._kw_partition, $._kw_replace, $._kw_select, $._kw_set, $._kw_sql_no_cache, $._kw_table, $._kw_text, $._kw_update, $._kw_values, $._kw_varchar, $._kw_where, $._kw_with] },
  rules: {
