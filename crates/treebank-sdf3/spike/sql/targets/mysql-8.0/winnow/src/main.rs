...
fn lxb_backtick(i: &mut In) -> ModalResult<()> {
...
fn lxb_dqstring(i: &mut In) -> ModalResult<()> {
    run((literal("\""), star(none_of(|c: char| matches!(c, '"'))), literal("\""),).void(), i)?;
    Ok(())
}
...
fn lxb_string(i: &mut In) -> ModalResult<()> {
    run(alt(((literal("'"), star(alt(((literal("''"),).void(), (none_of(|c: char| matches!(c, '\'')),).void(),))), literal("'"),).void(), (lxb_dqstring,).void(),)), i)?;
    Ok(())
}
