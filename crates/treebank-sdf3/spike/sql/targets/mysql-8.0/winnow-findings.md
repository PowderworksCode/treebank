...
- NAME rejects [AND, AS, ASC, BY, CREATE, DELETE, DESC, DROP, DUPLICATE, FROM, IGNORE, INSERT, INT, INTO, KEY, LIKE, LIMIT, NOT, NULL, OFFSET, ON, OR, ORDER, OVER, PARTITION, REPLACE, SELECT, SET, SQL_NO_CACHE, TABLE, TEXT, UPDATE, VALUES, VARCHAR, WHERE, WITH]: the matched text is compared against the list, which is SDF3's reject production exactly
