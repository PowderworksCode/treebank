...
; expanded into java's own node types. Edit queries/locals.scm and
...
[(annotation_type_body) (block) (class_body) (enum_body) (initializer_block) (interface_body) (lambda) (module_body) (program) (switch_block)] @local.scope
...
[(annotation_type_element name: (_) @local.definition.function) (compact_constructor_declaration name: (_) @local.definition.function) (constructor_declaration name: (_) @local.definition.function) (method_declaration name: (_) @local.definition.function)]

[(catch_parameter name: (_) @local.definition.var) (enum_constant name: (_) @local.definition.var) (parameter name: (_) @local.definition.var) (resource name: (_) @local.definition.var) (spread_parameter name: (_) @local.definition.var) (type_parameter name: (_) @local.definition.var) (type_pattern name: (_) @local.definition.var) (variable_declarator name: (_) @local.definition.var)]
...
[(identifier) (scoped_identifier) (scoped_type_identifier) (type_identifier)] @local.reference
