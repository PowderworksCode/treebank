...
; expanded into python's own node types. Edit queries/locals.scm and
...
[(module) (function_definition) (lambda) (class_definition) (list_comprehension) (set_comprehension) (dictionary_comprehension) (generator_expression)] @local.scope
...
[(class_definition name: (_) @local.definition.var) (double_star_parameter name: (_) @local.definition.var) (function_definition name: (_) @local.definition.var) (named_expression name: (_) @local.definition.var) (parameter name: (_) @local.definition.var) (star_parameter name: (_) @local.definition.var) (type_alias_statement name: (_) @local.definition.var) (type_parameter name: (_) @local.definition.var)]
...
[(double_star_parameter name: (_) @local.definition.parameter) (parameter name: (_) @local.definition.parameter) (star_parameter name: (_) @local.definition.parameter)]
...
[(dotted_name) (identifier)] @local.reference
