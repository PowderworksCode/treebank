...
; expanded into c's own node types. Edit queries/highlights.scm and
; regenerate, or the next --check will fail.
;
; Omitted: c has _clause, but no member of it takes
...
(_literal) @number
[(concatenated_string) (string_literal) (system_lib_string)] @string
...
[(identifier) (type_identifier)] @variable
...
[(function_declarator) (function_definition) (preproc_function_def)] @function
