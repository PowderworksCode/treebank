...
; expanded into rust's own node types. Edit queries/highlights.scm and
; regenerate, or the next --check will fail.
;
; Omitted: rust has _clause, but no member of it takes
...
[(identifier) (lifetime) (scoped_identifier) (type_identifier)] @variable
