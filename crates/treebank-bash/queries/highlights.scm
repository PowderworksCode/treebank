...
; expanded into bash's own node types. Edit queries/highlights.scm and
; regenerate, or the next --check will fail.
;
; Omitted: bash has no _type.
;
; Omitted: bash has _clause, but no member of it takes
...
(_literal) @number
[(ansi_c_string) (heredoc_body) (raw_string) (string)] @string
...
[(special_variable) (variable_name) (word)] @variable
