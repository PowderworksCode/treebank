...
; json's own node types. Edit queries/highlights.scm and regenerate, or the next
; --check will fail.
;
; Omitted: json has no _comment, _identifier, _type, _callable, _invocation, _loop, _branch, _jump, _directive.
