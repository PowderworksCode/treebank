...
; expanded into hcl's own node types. Edit queries/highlights.scm and
; regenerate, or the next --check will fail.
;
; Omitted: hcl has no _type, _callable, _jump, _directive.
;
; Omitted: hcl has _clause, but no member of it takes
...
(_literal) @number
[(heredoc_template) (quoted_template) (string_lit)] @string
