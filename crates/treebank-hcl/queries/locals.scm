...
; expanded into hcl's own node types. Edit queries/locals.scm and
; regenerate, or the next --check will fail.
;
; Omitted: hcl has no _callable, _parameter.
...
[(body) (config_file) (for_object_expr) (for_tuple_expr) (template_for)] @local.scope
...
[(attribute name: (_) @local.definition.var)]
